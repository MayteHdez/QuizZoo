...
{"key": "plato1", "img": "assets/imagenes_general/plato1.png", "precio": 10},
{"key": "pescado", "img": "assets/imagenes_general/pescado.png", "precio": 25},
{"key": "brocoli", "img": "assets/imagenes_general/brocoli.png", "precio": 15},
{"key": "zanahoria", "img": "assets/imagenes_general/zanahoria.png", "precio": 15},
{"key": "chicharo", "img": "assets/imagenes_general/chicharo.png", "precio": 10},
{"key": "moras", "img": "assets/imagenes_general/moras.png", "precio": 10},
{"key": "salmon", "img": "assets/imagenes_general/salmon.png", "precio": 25},
{"key": "plato2", "img": "assets/imagenes_general/plato2.png", "precio": 10},
...
final userDoc =
FirebaseFirestore.instance.collection("usuario").doc(UsuarioSesion.email);
...
feedback: Image.asset(item["img"] as String, width: 100),
...
Expanded(
child: _infoBox(Icons.attach_money, "Monedas: ${UsuarioSesion.monedas}")),
],
),
);
}
...
return Image.asset("assets/imagenes_general/canasta.png", height: 100);
},
),
...
onPressed: () {
Navigator.push(
context, MaterialPageRoute(builder: (context) => const MapaScreen()));
},
style: ElevatedButton.styleFrom(
